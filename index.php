    ...
    <div class="container">
        ...
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <div class="new-account">
                <span style="color: rgba(0, 0, 0, 0.54); font-weight: bolder; font-family: 'Source Sans Pro'; color:red">Don't have an account?</span> 
                <a href="templates/2-sign-up.php" style="text-decoration: none;"><span style="color: rgba(5, 0, 255, 0.81); font-weight: bolder; font-family: 'Source Sans Pro';">Register Now!</span></a>
            </div>

        </form>

        <div class="img-container">
            <img src="static/images/file.png" alt="Login-screen-picture">
        </div>
    </div>
