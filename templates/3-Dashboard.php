<?php 
    ...
    {
        $today_expense = "No Expenses Today";
    }
    else
    {
    ...
    {
        $Yesterday_expense = "No Expenses Yesterday";
    }
    else
    {
    ...
    {
        $week_expense = "No Expenses This Week";
    }
    else
    {
    ...
    {
        $total_expenses = "No Expenses Yet";
    }
    else
    {
...
?>
    ...
    <footer style="text-align: right; margin-top: 20px; font-size: 0.9em;">
